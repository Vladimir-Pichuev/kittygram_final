...
#ALLOWED_HOSTS = ['rinens.sytes.net', '127.0.0.1', 'localhost', '158.160.0.130'] 

SECRET_KEY = os.getenv('SECRET_KEY', 'django')

DEBUG = os.getenv('DEBUG') == 'True'

ALLOWED_HOSTS = os.getenv('ALLOWED_HOSTS', ['rinens.sytes.net', '127.0.0.1', 'localhost', '158.160.0.130'])
